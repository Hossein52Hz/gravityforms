...
class GFPersian_Gateway_Vandar
{
    ...
    public static function feed_page()
    {
        ...
        <h3>
            <span><i class="fa fa-credit-card"></i> <?php esc_html_e('وندار', 'gravityformsvandar') ?>
                <a id="add-new-confirmation" class="add-new-h2" href="<?php echo esc_url(admin_url('admin.php?page=gf_vandar&view=edit&fid=' . absint(rgget("id")))) ?>"><?php esc_html_e('افزودن فید جدید', 'gravityformsvandar') ?></a></span>
            <a class="add-new-h2" href="admin.php?page=gf_vandar&view=stats&id=<?php echo absint(rgget("id")) ?>"><?php _e("نمودار ها", "gravityformsvandar") ?></a>
        </h3>
        ...
        <div class="wrap">
            ...
            <?php if ($arg != 'per-form') { ?>
                ...
                <h2>
                    ...
                    if (get_option("gf_vandar_configured")) { ?>
                        <a class="add-new-h2" href="admin.php?page=gf_vandar&view=edit"><?php _e("افزودن جدید", "gravityformsvandar") ?></a>
                    <?php
                    } ?>
                </h2>
            ...
            <form id="confirmation_list_form" method="post">
                ...
                <div class="tablenav">
                    <div class="alignleft actions" style="padding:8px 0 7px 0;">
                        <label class="hidden" for="bulk_action"><?php _e("اقدام دسته جمعی", "gravityformsvandar") ?></label>
                        ...
                        ?>
                        <a class="button button-primary" href="admin.php?page=gf_settings&subview=gf_vandar"><?php _e('تنظیمات حساب وندار', 'gravityformsvandar') ?></a>
                    </div>
                </div>
                <table class="wp-list-table widefat fixed striped toplevel_page_gf_edit_forms" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" id="active" class="manage-column" style="width:<?php echo $arg != 'per-form' ? '50px' : '20px' ?>"><?php echo $arg != 'per-form' ? __('وضعیت', 'gravityformsvandar') : '' ?></th>
                            <th scope="col" class="manage-column" style="width:<?php echo $arg != 'per-form' ? '65px' : '30%' ?>"><?php _e(" آیدی فید", "gravityformsvandar") ?></th>
                            <?php if ($arg != 'per-form') { ?>
                                <th scope="col" class="manage-column"><?php _e("فرم متصل به درگاه", "gravityformsvandar") ?></th>
                            <?php } ?>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th scope="col" id="active" class="manage-column"><?php echo $arg != 'per-form' ? __('وضعیت', 'gravityformsvandar') : '' ?></th>
                        ...
                        ?>
                            ...
                            ?>
                                <tr class='author-self status-inherit' valign="top">
                                    ...
                                    <td><img style="cursor:pointer;width:25px" src="<?php echo esc_url(GFCommon::get_base_url()) ?>/images/active<?php echo intval($setting["is_active"]) ?>.png" alt="<?php echo $setting["is_active"] ? __("درگاه فعال است", "gravityformsvandar") : __("درگاه غیر فعال است", "gravityformsvandar"); ?>" title="<?php echo $setting["is_active"] ? __("درگاه فعال است", "gravityformsvandar") : __("درگاه غیر فعال است", "gravityformsvandar"); ?>" onclick="ToggleActive(this, <?php echo $setting['id'] ?>); " /></td>

                                    <td><?php echo $setting["id"] ?>
                                        <?php if ($arg == 'per-form') { ?>
                                            <div class="row-actions">
                                                <span class="edit">
                                                    <a title="<?php _e("ویرایش فید", "gravityformsvandar") ?>" href="admin.php?page=gf_vandar&view=edit&id=<?php echo $setting["id"] ?>"><?php _e("ویرایش فید", "gravityformsvandar") ?></a>
                                                    |
                                                </span>
                                                <span class="trash">
                                                    <a title="<?php _e("حذف", "gravityformsvandar") ?>" href="javascript: if(confirm('<?php _e("فید حذف شود؟ ", "gravityformsvandar") ?> <?php _e("\'Cancel\' برای انصراف, \'OK\' برای حذف کردن.", "gravityformsvandar") ?>')){ DeleteSetting(<?php echo $setting["id"] ?>);}"><?php _e("حذف", "gravityformsvandar") ?></a>
                                                </span>
                                            </div>
                                        <?php } ?>
                                    </td>
                                    ...
                                    <?php if ($arg != 'per-form') { ?>
                                        <td class="column-title">
                                            <strong><a class="row-title" href="admin.php?page=gf_vandar&view=edit&id=<?php echo $setting["id"] ?>" title="<?php _e("تنظیم مجدد درگاه", "gravityformsvandar") ?>"><?php echo $setting["form_title"] ?></a></strong>
                                            ...
                                            <div class="row-actions">
                                                ...
                                                <span class="trash">
                                                    <a title="<?php _e("حذف فید", "gravityformsvandar") ?>" href="javascript: if(confirm('<?php _e("فید حذف شود؟ ", "gravityformsvandar") ?> <?php _e("\'Cancel\' برای انصراف, \'OK\' برای حذف کردن.", "gravityformsvandar") ?>')){ DeleteSetting(<?php echo $setting["id"] ?>);}"><?php _e("حذف", "gravityformsvandar") ?></a>
                                                    |
                                                </span>
                                                <span class="view">
                                                    <a title="<?php _e("ویرایش فرم", "gravityformsvandar") ?>" href="admin.php?page=gf_edit_forms&id=<?php echo $setting["form_id"] ?>"><?php _e("ویرایش فرم", "gravityformsvandar") ?></a>
                                                    |
                                                </span>
                                                <span class="view">
                                                    <a title="<?php _e("مشاهده صندوق ورودی", "gravityformsvandar") ?>" href="admin.php?page=gf_entries&view=entries&id=<?php echo $setting["form_id"] ?>"><?php _e("صندوق ورودی", "gravityformsvandar") ?></a>
                                                    |
                                                </span>
                                                <span class="view">
                                                    <a title="<?php _e("نمودارهای فرم", "gravityformsvandar") ?>" href="admin.php?page=gf_vandar&view=stats&id=<?php echo $setting["form_id"] ?>"><?php _e("نمودارهای فرم", "gravityformsvandar") ?></a>
                                                </span>
                                            </div>
                                        </td>
                                    <?php } ?>
                ...
                <div id="edit_payment_status_details" style="display:block">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="vandar_transaction_id" name="vandar_transaction_id" value="<?php echo $transaction_id ?>"></td>
                        </tr>
    ...
    public static function update_payment_entry($form, $entry_id)
    {
        ...
        // Validate and sanitize the payment date
        if (!empty($payment_date)) {
            $datetime_parts = explode(" ", $payment_date);
            if (count($datetime_parts) == 2) {
                list($date, $time) = $datetime_parts;
                $date_parts = explode("-", $date);
                $time_parts = explode(":", $time);

                if (count($date_parts) == 3 && count($time_parts) == 3) {
                    list($Y, $m, $d) = $date_parts;
                    list($H, $i, $s) = $time_parts;

                    // Convert Jalali date to Gregorian
                    $miladi = GF_jalali_to_gregorian($Y, $m, $d);

                    // Validate the converted date and time
                    if (checkdate($miladi[1], $miladi[2], $miladi[0]) && $H >= 0 && $H < 24 && $i >= 0 && $i < 60 && $s >= 0 && $s < 60) {
    ...
    public static function settings_page()
    {
        ...
        <form action="" method="post">
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row"><label for="gf_vandar_configured"><?php _e("فعالسازی", "gravityformsvandar"); ?></label></th>
                    <td>
                        <input type="checkbox" name="gf_vandar_configured" id="gf_vandar_configured" <?php echo get_option("gf_vandar_configured") ? "checked='checked'" : "" ?> />
                        <label class="inline" for="gf_vandar_configured"><?php _e("بله", "gravityformsvandar"); ?></label>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input style="width:350px;text-align:left;direction:ltr !important" type="text" id="gf_vandar_api_p" name="gf_vandar_api_p" value="<?php echo sanitize_text_field(rgar($settings, 'api_p')) ?>" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input style="width:350px;" type="text" id="gf_vandar_gname" name="gf_vandar_gname" value="<?php echo $gateway_title; ?>" />
                    </td>
                </tr>

                <tr>
                    <td colspan="2"><input style="font-family:tahoma !important;" type="submit" name="gf_vandar_submit" class="button-primary" value="<?php _e("ذخیره تنظیمات", "gravityformsvandar") ?>" /></td>
                </tr>
        ...
        <form action="" method="post">
            ...
            ?>
                ...
                <div class="delete-alert alert_red">
                    ...
                    <div class="gf_delete_notice"><?php _e("تذکر : بعد از غیرفعالسازی تمامی اطلاعات مربوط به وندار حذف خواهد شد", "gravityformsvandar") ?></div>
    ...
    private static function config_page()
    {
        ...
        <div class="wrap gforms_edit_form gf_browser_gecko">
            ...
            <h2 class="gf_admin_page_title"><?php _e("وندارکربندی درگاه وندار", "gravityformsvandar") ?>
                ...
                <?php if (!empty($_get_form_id)) { ?>
                    <span class="gf_admin_page_subtitle">
                        <span class="gf_admin_page_formid"><?php echo sprintf(__("فید: %s", "gravityformsvandar"), $id) ?></span>
                        <span class="gf_admin_page_formname"><?php echo sprintf(__("فرم: %s", "gravityformsvandar"), $form_name) ?></span>
                    </span>
                <?php } ?>

            </h2>
            <a class="button add-new-h2" href="admin.php?page=gf_settings&subview=gf_vandar" style="margin:8px 9px;"><?php _e("تنظیمات حساب وندار", "gravityformsvandar") ?></a>
            ...
            ?>
                <div class="updated fade" style="padding:6px"><?php echo sprintf(__("فید به روز شد . %sبازگشت به لیست%s.", "gravityformsvandar"), "<a href='?page=gf_vandar'>", "</a>") ?></div>
            <?php
            }
                            ...
                            if (RG_CURRENT_VIEW != 'entry') { ?>
                                <select name="form_switcher" id="form_switcher" onchange="GF_SwitchForm(jQuery(this).val());">
                                    ...
                                    <?php foreach ($feeds as $feed) {
                                        ...
                                        <option value="<?php echo $feed["id"] ?>" <?php echo $selected ?>><?php echo sprintf(__('فرم: %s (فید: %s)', 'gravityformsvandar'), $feed["form_title"], $feed["id"]) ?></option>
                                    <?php } ?>
                                </select>
                            <?php
                            }
                        ...
                        <div id="form_settings" class="gform_panel gform_panel_form_settings">
                            ...
                            <form method="post" action="" id="gform_form_settings">
                                ...
                                <table class="form-table gforms_form_settings" cellspacing="0" cellpadding="0">
                                    <tbody>
                                        ...
                                        <tr style="<?php echo rgget('id') || rgget('fid') ? 'display:none !important' : ''; ?>">
                                            ...
                                            <td>
                                                <select id="gf_vandar_form" name="gf_vandar_form" onchange="GF_SwitchFid(jQuery(this).val());">
                                                    <option value=""><?php _e("یک فرم انتخاب نمایید", "gravityformsvandar"); ?> </option>
                                                    <?php
                                                ...
                                                <img src="<?php echo esc_url(GFCommon::get_base_url()) ?>/images/spinner.gif" id="vandar_wait" style="display: none;" />
                                            </td>
                                        </tr>
                                ...
                                <?php if (empty($has_product) || !$has_product) { ?>
                                    <div id="gf_vandar_invalid_product_form" class="gf_vandar_invalid_form" style="background-color:#FFDFDF; margin-top:4px; margin-bottom:6px;padding:18px; border:1px dotted #C89797;">
                                        <?php _e("فرم انتخاب شده هیچ گونه فیلد قیمت گذاری ندارد، لطفا پس از افزودن این فیلدها مجددا اقدام نمایید.", "gravityformsvandar") ?>
                                    </div>
                                <?php } else { ?>
                                    <table class="form-table gforms_form_settings" id="vandar_field_group" <?php echo empty($_get_form_id) ? "style='display:none;'" : "" ?> cellspacing="0" cellpadding="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" name="gf_vandar_type" id="gf_vandar_type_subscription" value="subscription" <?php echo rgar($config['meta'], 'type') == "subscription" ? "checked='checked'" : "" ?> />
...
-->
                                            ...
                                            <tr <?php echo $display_post_fields ? "" : "style='display:none;'" ?>>
                                                ...
                                                <td>
                                                    <select id="gf_vandar_update_action1" name="gf_vandar_update_action1">
                                                        <option value="default" <?php echo rgar($config["meta"], "update_post_action1") == "default" ? "selected='selected'" : "" ?>><?php _e("وضعیت وندارشفرض فرم", "gravityformsvandar") ?></option>
                                                        <option value="publish" <?php echo rgar($config["meta"], "update_post_action1") == "publish" ? "selected='selected'" : "" ?>><?php _e("منتشر شده", "gravityformsvandar") ?></option>
                                                        <option value="draft" <?php echo rgar($config["meta"], "update_post_action1") == "draft" ? "selected='selected'" : "" ?>><?php _e("وندارشنویس", "gravityformsvandar") ?></option>
                                                        <option value="pending" <?php echo rgar($config["meta"], "update_post_action1") == "pending" ? "selected='selected'" : "" ?>><?php _e("در انتظار بررسی", "gravityformsvandar") ?></option>
                                                        <option value="private" <?php echo rgar($config["meta"], "update_post_action1") == "private" ? "selected='selected'" : "" ?>><?php _e("خصوصی", "gravityformsvandar") ?></option>
                                                    </select>
                                                </td>
                                            </tr>
                                            ...
                                            <tr <?php echo $display_post_fields ? "" : "style='display:none;'" ?>>
                                                ...
                                                <td>
                                                    <select id="gf_vandar_update_action2" name="gf_vandar_update_action2">
                                                        <option value="dont" <?php echo rgar($config["meta"], "update_post_action2") == "dont" ? "selected='selected'" : "" ?>><?php _e("عدم ایجاد پست", "gravityformsvandar") ?></option>
                                                        <option value="default" <?php echo rgar($config["meta"], "update_post_action2") == "default" ? "selected='selected'" : "" ?>><?php _e("وضعیت وندارشفرض فرم", "gravityformsvandar") ?></option>
                                                        <option value="publish" <?php echo rgar($config["meta"], "update_post_action2") == "publish" ? "selected='selected'" : "" ?>><?php _e("منتشر شده", "gravityformsvandar") ?></option>
                                                        <option value="draft" <?php echo rgar($config["meta"], "update_post_action2") == "draft" ? "selected='selected'" : "" ?>><?php _e("وندارشنویس", "gravityformsvandar") ?></option>
                                                        <option value="pending" <?php echo rgar($config["meta"], "update_post_action2") == "pending" ? "selected='selected'" : "" ?>><?php _e("در انتظار بررسی", "gravityformsvandar") ?></option>
                                                        <option value="private" <?php echo rgar($config["meta"], "update_post_action2") == "private" ? "selected='selected'" : "" ?>><?php _e("خصوصی", "gravityformsvandar") ?></option>
                                                    </select>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" name="gf_vandar_addon" id="gf_vandar_addon_true" value="true" <?php echo rgar($config['meta'], 'addon') == "true" ? "checked='checked'" : "" ?> />
                                                    <label for="gf_vandar_addon"></label>
                                                    <span class="description"><?php _e('برخی افزودنی های گرویتی فرم دارای متد add_delayed_payment_support هستند. در صورتی که میخواهید این افزودنی ها تنها در صورت تراکنش موفق عمل کنند این گزینه را تیک بزنید.', 'gravityformsvandar'); ?></span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr id="gf_vandar_conditional_option">
                                                ...
                                                <td>
                                                    <input type="checkbox" id="gf_vandar_conditional_enabled" name="gf_vandar_conditional_enabled" value="1" onclick="if(this.checked){jQuery('#gf_vandar_conditional_container').fadeIn('fast');} else{ jQuery('#gf_vandar_conditional_container').fadeOut('fast'); }" <?php echo rgar($config['meta'], 'vandar_conditional_enabled') ? "checked='checked'" : "" ?> />
                                                            ...
                                                            <td>
                                                                <div id="gf_vandar_conditional_container" <?php echo !rgar($config['meta'], 'vandar_conditional_enabled') ? "style='display:none'" : "" ?>>
                                                                    ...
                                                                    foreach ($condition_field_ids as $i => $value) : ?>
                                                                        ...
                                                                        <div class="gf_vandar_conditional_div" id="gf_vandar_<?php echo $i; ?>__conditional_div">

                                                                            <select class="gf_vandar_conditional_field_id" id="gf_vandar_<?php echo $i; ?>__conditional_field_id" name="gf_vandar_conditional_field_id[<?php echo $i; ?>]" title="">
                                                                            </select>

                                                                            <select class="gf_vandar_conditional_operator" id="gf_vandar_<?php echo $i; ?>__conditional_operator" name="gf_vandar_conditional_operator[<?php echo $i; ?>]" style="font-family:tahoma,serif !important" title="">
                                                                            ...
                                                                            <div id="gf_vandar_<?php echo $i; ?>__conditional_value_container" style="display:inline;">
                                                                            </div>
                                                                    ...
                                                                    <input type="hidden" value="<?php echo key(array_slice($condition_field_ids, -1, 1, true)); ?>" id="gf_vandar_conditional_counter">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="submit" class="button-primary gfbutton" name="gf_vandar_submit" value="<?php _e("ذخیره", "gravityformsvandar"); ?>" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
        ...
        <style type="text/css">
            ...
            #gf_vandar_conditional_container *,
            .delete_this_condition *,
            .add_new_condition * {
                outline: none !important;
            }
...
<?php
    ...
    public static function Request($confirmation, $form, $entry, $ajax)
    {
        ...
        try {
            ...
            $Result = wp_remote_post('https://ipg.vandar.app/api/v4/send', array(
                'method' => 'POST',
                'headers' => array(
            ...
            if (!empty($Result['status']) && $Result['status']) {
                ...
                $payment_URL = sprintf('https://ipg.vandar.app/web/v4/%s', $Result['token']);
        ...
        if (isset($entry["payment_method"]) && $entry["payment_method"] == 'vandar') {
            ...
            if (empty($_GET['no']) || $_GET['no'] != 'true') {
                ...
                try {
                    ...
                    $Result = wp_remote_post('https://ipg.vandar.app/api/v4/verify', array(
                        'method' => 'POST',
                        'headers' => array(
                            'Content-type: application/x-www-form-urlencoded',
                            'Accept: application/json'
                    ...
                    if (!empty($Result['status']) && $Result['status'] && $Result['status'] == 1) {
                        $Status = 'completed';
                        $Message = '';
                    } else {
                        $Status = 'failed';
